...
function init(resultFromServer) {
    ...
    temparature = temperatureElement.innerHTML;
...
volume.addEventListener("click", () => {
    ...
    // console.log(weatherDescriptionHeader.innerText)
    // console.log(temparature);
    utterance = new SpeechSynthesisUtterance(`Current Weather at ${cityHeader.innerHTML} is ${weatherDescriptionHeader.innerText}... and Temperature is ${temparature} Celcius`);
